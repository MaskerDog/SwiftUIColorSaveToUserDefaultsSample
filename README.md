# UserDefaultsにSwiftUIのColorを保存する
...
Codableに準拠した構造体をJSONEncoderやJSONDecoderを使ってUserDefaultsでやり取りできるようにする。
ColorはCodableに準拠していないため、extensionでColorをCodableに準拠させる。
